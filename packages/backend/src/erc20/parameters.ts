...
export class GetTokenInfoByTokenAddressParameters extends createToolParameters(
  z.object({
    tokenAddress: z
      .string()
      .describe("The address of the token to get the info of"),
  })
) {}
...
export class GetTokenTotalSupplyParameters extends createToolParameters(
  z.object({
    tokenAddress: z
      .string()
      .describe("The address of the token to get total supply of"),
  })
) {}
...
export class GetTokenAllowanceParameters extends createToolParameters(
  z.object({
    tokenAddress: z
      .string()
      .describe("The address of the token to check the allowance of"),
...
export class ApproveParamters extends createToolParameters(
  z.object({
...
export class ConvertToBaseUnitParameters extends createToolParameters(
  z.object({
    amount: z
      .number()
      .describe(
        "The amount of tokens to convert from decimals units to base units"
      ),
...
export class ConvertFromBaseUnitParameters extends createToolParameters(
  z.object({
    amount: z
      .number()
      .describe(
        "The amount of tokens to convert from base units to decimals units"
      ),
    decimals: z.number().describe("The number of decimals of the token"),
  })
) {}
